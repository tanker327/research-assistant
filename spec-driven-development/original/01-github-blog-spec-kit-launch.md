...
**Author:** Den Delimarsky ([@localden](https://github.com/localden)), Principal Product Manager
**Published:** September 2, 2025
**Reading time:** 9 minutes
**Tags:** GitHub Copilot, open source, Spec-driven development
...
It works in four phases with clear checkpoints. Each phase has a specific job, and you don't move to the next one until the current task is fully validated.
...
4. **Implement**: Your coding agent tackles the tasks one by one (or in parallel, where applicable). Instead of reviewing thousand-line code dumps, you, the developer, review focused changes that solve specific problems. The coding agent knows what it's supposed to build because the specification told it. It knows how to build it because the plan told it. And it knows exactly what to work on because the task told it.
...
Areas where community feedback is welcomed:
...
- **Possible VS Code integrations**: Exploring ways to bring this workflow directly into VS Code.
- **Comparing and diffing multiple implementations**: Iterating and diffing between implementations opens up creative possibilities.
- **Managing specs and tasks at scale in your organization**: Managing lots of Markdown files can get overwhelming.

Share your experience and feedback at: https://github.com/github/spec-kit/issues
