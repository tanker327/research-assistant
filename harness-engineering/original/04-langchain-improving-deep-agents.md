...
![Terminal Bench Scores](images/04-terminal-bench-scores.png)
...
![Experiment Results](images/04-langsmith-trace.png)
...
![Trace Analyzer Skill](images/04-trace-analyzer-skill.png)
...
![Self-Verification Loop](images/04-self-verification-loop.png)
...
![The Reasoning Sandwich](images/04-reasoning-sandwich.png)__Spending more reasoning compute on planning and verification__
